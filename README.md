...
muj> (@ユーザー名) (1-200) : 指定したユーザーとめりたんを賭けてジャンケン。
...
mbuy> (称号A-Z) : めりたんbotから 3000めりたん で指定した称号を強制的に買い取る。
```
...
### Running meritum Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start meritum locally by running:
...
Then you can interact with meritum by typing `meritum help`.

    meritum> meritum help
    meritum animate me <query> - The same thing as `image me`, except adds [snip]
    meritum help - Displays all of the help commands that meritum knows about.
    ...
