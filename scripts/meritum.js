...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, accounts_1.Account.sync()];
            case 1:
                _a.sent();
...
module.exports = function (robot) {
    ...
    // ヘルプ表示
    robot.hear(/^mlogin>$/i, function (res) { return __awaiter(void 0, void 0, void 0, function () {
        var user, slackId, name, realName, slack, displayName, t, accont, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
